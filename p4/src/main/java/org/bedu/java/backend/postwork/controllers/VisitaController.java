...
public class VisitaController {
  ...
  @PostMapping
  public ResponseEntity<Void> createVisita(@Valid @RequestBody Visita visita, @RequestParam Long clienteId){
    return ResponseEntity.created(URI.create("")).build();
  }

  @PutMapping("/{visitaId}")
  public ResponseEntity<Void> updateVisita(@PathVariable Long visitaId, @Valid @RequestBody Visita visita){
