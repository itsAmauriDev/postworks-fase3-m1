...
public class VentaController {
  ...
  @PostMapping
  public ResponseEntity<Void> createVenta(@Valid @RequestBody Venta venta, @RequestParam Long clienteId){
    return ResponseEntity.created(URI.create("")).build();
  }

  @PutMapping("/{ventaId}")
  public ResponseEntity<Void> updateVenta(@PathVariable Long ventaId, @Valid @RequestBody Venta venta){
