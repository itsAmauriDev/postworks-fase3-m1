...
public class EtapaController {
  ...
  @PostMapping
  public ResponseEntity<Void> createEtapa(@RequestBody Etapa etapa, @RequestParam Long clienteId){
    return ResponseEntity.created(URI.create("")).build();
  }

  @PutMapping("/{etapaId}")
  public ResponseEntity<Etapa> updateEtapa(@PathVariable Long etapaId, @RequestBody Etapa etapa){
